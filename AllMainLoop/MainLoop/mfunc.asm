...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;                                                                            ;
;                         FUNCTIONS FOR REMOTE MAIN LOOP                     ;
;                                   EE/CS 51                                 ;
;                                                                            ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
DisplayUnIdentifiedError:
	...
	MOV errorflag, 0 ; now that we have displayed error, can move on
...
IntGetReceivedData: 
    CMP errorflag, ERROR_FLAG_VAL ; if the error flag is set (meaning
                                  ; a serial error occurred), no dat
...
DB 'S16384 ',CARRIAGE_RETURN		 ; responds to key press 2     
DB 'S30000 ',CARRIAGE_RETURN	     ; responds to key press 3     
DB 'S32767 ',CARRIAGE_RETURN	     ; responds to key press 4

DB 'V1000  ',CARRIAGE_RETURN		 ; responds to key press 5      
DB 'V-1000 ',CARRIAGE_RETURN	     ; responds to key press 6 
DB 'V10000 ',CARRIAGE_RETURN	     ; responds to key press 7
DB 'V-10000',CARRIAGE_RETURN	     ; responds to key press 8
...
DB 'D45    ',CARRIAGE_RETURN	     ; responds to key press 13 
DB 'D-45   ',CARRIAGE_RETURN	     ; responds to key press 14 
...
DB 'right  ',ASCII_NULL		; corresponds to key press in third row, 
                            ; first column of keyboard       
DB 'left   ',ASCII_NULL	    ; corresponds to key press in third row, 
                            ; second column of keyboard  
DB 'forwrd ',ASCII_NULL		; corresponds to key press in third row, 
                            ; third column of keyboard        
DB 'backwrd',ASCII_NULL	    ; corresponds to key press in third row, 
                            ; fourth column of keyboard  

DB 'r angle',ASCII_NULL	    ; corresponds to key press in fourth row, 
                            ; first column of keyboard  
DB 'l angle',ASCII_NULL	    ; corresponds to key press in fourth row, 
                            ; second column of keyboard    
DB 'f laser',ASCII_NULL	    ; corresponds to key press in fourth row, 
                            ; third column of keyboard   
DB 'o laser',ASCII_NULL		; corresponds to key press in fourth row, 
                            ; fourth column of keyboard     
