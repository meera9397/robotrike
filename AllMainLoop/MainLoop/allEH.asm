...
;                   event handlers for the keypad, display, and serial ports. 
; Table of Contents:
...
; 3) Serial_EventHandler: calls function to deal with serial interrupts
;						  and then sends an EOI when done. 
; 4) Install_Serial_Handler: installs event handler for INT2 interrupt
