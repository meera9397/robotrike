...
SerialPutStringMotor     PROC        NEAR
        PUBLIC      SerialPutStringMotor
ContSerialPutStringMotor: 
    ...
    CMP remoteindex, DISPLAY_LEN + 1 ; all strings are of DISPLAY_LEN - 1
                                     ; length
    JG CheckSerialPutStringMotor ; if the remote index is DISPLAY_LEN - 1,
