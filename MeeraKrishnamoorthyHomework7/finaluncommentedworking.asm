...
SetOtherThings: 
    ; because LCR should be 0 now, do not need to save value of AL
    ; if we did, because parity was changed, that value would
    ; be outputted in AL
...
SetDLAB: 
	MOV DX, SERIAL_LCR ; make sure that DX is set
